...
<div class="mx-auto flex min-h-screen items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
    <div class="w-full max-w-md">
        ...
        <form method="post" class="mt-8 space-y-5">
            ...
            <button class="inline-flex w-full items-center justify-center rounded-xl bg-slate-900 px-6 py-4 text-sm font-semibold text-white hover:bg-slate-800">Send Reset Link</button>
        </form>
