                            ...
                            <tr class="border-t border-slate-200 bg-white">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <a
                                            href="<?= BASE_URL ?>/admin/slides.php?edit=<?= $item['id'] ?>"
