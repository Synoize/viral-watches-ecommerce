            ...
            <table class="w-full border-separate border-spacing-0 text-left text-sm">
                <thead class="bg-slate-100 text-slate-600">
                    <tr>
                        ...
                        <th class="px-2 py-4">Stock</th>
                        <th class="px-2 py-4">Best Seller</th>
                        <th class="px-2 py-4">Video</th>
                ...
                <tbody>
                    <?php foreach ($products as $item): ?>
                        <tr class="border-t border-slate-200 bg-white">
                            <td class="px-4 py-4 text-slate-900"><?= sanitize($item['name']) ?></td>
                            <td class="px-4 py-4 text-slate-700"><?= sanitize($item['category_name'] ?? 'Uncategorized') ?></td>
                            <td class="px-4 py-4 text-slate-900">₹<?= number_format($item['price'], 2) ?></td>
                            <td class="px-2 py-4 text-slate-700"><?= (int)$item['stock'] ?></td>
                            <td class="px-2 py-4">
                            ...
                            <td class="px-4 py-4 space-x-2 flex">
                                <a class="inline-flex rounded-full border border-slate-200 bg-slate-100 px-4 py-2 text-sm text-slate-900 hover:bg-slate-50" href="<?= publicUrl('/admin/products?action=edit&id=' . $item['id']) ?>">Edit</a>
