                    ...
                    <?php foreach ($categories as $cat): ?>
                        <tr class="border-t border-slate-200 bg-white">
                            ...
                            <td class="flex space-x-2 px-6 py-4">
                                <a class="inline-flex rounded-full border border-slate-200 bg-slate-100 px-4 py-2 text-sm text-slate-900 hover:bg-slate-50" href="<?= publicUrl('/admin/categories?edit=' . (int)$cat['id']) ?>">Edit</a>
